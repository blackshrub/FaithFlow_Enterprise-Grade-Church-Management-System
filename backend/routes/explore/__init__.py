...
# Super Admin router
explore_admin_router = APIRouter(prefix="/api/explore/admin", tags=["Explore - Super Admin"])
explore_admin_router.include_router(admin_router)

# Church Admin router
explore_church_router = APIRouter(prefix="/api/explore/church", tags=["Explore - Church Admin"])
