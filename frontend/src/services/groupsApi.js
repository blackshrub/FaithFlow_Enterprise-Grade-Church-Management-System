...
export const getJoinRequests = (params) =>
  api.get('/v1/groups/join-requests', { params });

export const approveJoinRequest = (id) =>
  api.post(`/v1/groups/join-requests/${id}/approve`);

export const rejectJoinRequest = (id) =>
  api.post(`/v1/groups/join-requests/${id}/reject`);

export const getLeaveRequests = (params) =>
  api.get('/v1/groups/leave-requests', { params });
