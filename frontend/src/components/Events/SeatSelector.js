...
function SeatSelector({ eventId, sessionId, layoutId, selectedSeat, onSeatSelect }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Stage */}
      <div className="bg-gradient-to-b from-gray-800 to-gray-700 text-white text-center py-2 rounded-t-lg">
        <p className="font-bold text-sm">{t('events.seatLayout.stage')}</p>
      </div>

      {/* Seat Grid */}
      <div className="bg-gray-50 p-4 rounded-b-lg overflow-x-auto">
