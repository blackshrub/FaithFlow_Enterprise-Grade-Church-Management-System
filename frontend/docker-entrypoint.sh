...
echo "  API_URL: \"${VITE_API_URL:-}\"," >> ${BUILD_DIR}/runtime-config.js
echo "  APP_NAME: \"${VITE_APP_NAME:-FaithFlow}\"," >> ${BUILD_DIR}/runtime-config.js
echo "  APP_VERSION: \"${VITE_APP_VERSION:-2.0.0}\"," >> ${BUILD_DIR}/runtime-config.js
echo "  ENVIRONMENT: \"${NODE_ENV:-production}\"" >> ${BUILD_DIR}/runtime-config.js
echo "};" >> ${BUILD_DIR}/runtime-config.js

echo "Runtime config created with API_URL: ${VITE_API_URL:-'(not set)'}"
